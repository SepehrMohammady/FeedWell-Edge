...
\textbf{Expected Outcome:} Smartphone recommendation model $< 5\text{MB}$, inference $< 50\text{ms}$, update $< 100\text{ms}$, with validated transfer to STM32 microcontroller.
